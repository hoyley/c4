...
def read_command(argv):
    ...
    parser.add_option('-r', '--numRows', dest='num_rows', type='int', default=7)
    parser.add_option('-c', '--numCols', dest='num_cols', type='int', default=6)
...
def run_command(player1, player2, num_training, num_games, num_rows, num_cols, line_length):
